...
public class Mutation {
	...
	public static void threeOptMove(Routage2 routage){
		int n = routage.tailleRoute();
		int i = 0;
		int j = 0;
		int k = 0;
	...
	public void changePlace(Routage2 routage) {
		int n = routage.tailleRoute();
		int randIndex1=0;
		int randIndex2=0;
		while (randIndex1==randIndex2){
	...
	public void moveSequence(Routage2 routage) {
		int n = routage.tailleRoute();
	...
	public static void moveReverse(Routage2 routage) {
	...
	public static void pruningTwoOptMove(int[][] mat,Routage2 routage, int N) {
		int n = routage.tailleRoute();
		int randIndex1 = 0;//Indice du noeud c2
		int randIndex2 = 0;//Indice du noeud c1'
		int i;
