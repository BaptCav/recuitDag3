...
public class Recuit extends JFrame
{
	...
	{	
		...
		ParametreGamma gamma = new ParametreGamma(0.5,0.5/nombreIterations,0.01);// Rappel : 1000 echantillons
		...
		for(int i =0; i<nombreIterations;i++){
			...
			for(int j=0;j<nombreEtat;j++){// on effectue M  fois la mutation sur chaque particule avant de descendre gamma
				...
				for(int k=0; k<M; k++){
					...
					double delta = deltapot/nombreEtat  - valueJ*p.differenceSpins(r2,m);
